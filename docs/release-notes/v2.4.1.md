...
If you are stuck on 2.4.0.1 and cannot uninstall it: updating to 2.4.1.1 through the catalogue is enough, and the folder from the older install is replaced in place.
